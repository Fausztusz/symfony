...
class Task
{
    ...
    #[ORM\Column(type: 'TaskStatus', options: ['default' => TaskStatus::TODO])]
    private string $status = TaskStatus::TODO;

    #[ORM\Column(type: 'TaskPriority', options: ['default' => TaskPriority::MEDIUM])]
    private string $priority = TaskPriority::MEDIUM;
